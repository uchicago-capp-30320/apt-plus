...
def insert_staging_data(cur, features):
...
def delete_outdated_amenities(cur):
...
def grocery_elt_pipeline():
    ...
    def transform(features):
        ...
        insert_staging_data(cur, features)
        conn.commit()
        cur.close()
        conn.close()
    ...
    def merge():
        ...
        conn = get_connection()
        cur = conn.cursor()
        upsert_amenities(cur)
        delete_outdated_amenities(cur)
        conn.commit()
        cur.close()
        conn.close()
